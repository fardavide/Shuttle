...
internal object ItStrings : Strings {
    ...
    override val PermissionsTitle = "Permessi"
    ...
    object Accessibility : Strings.Accessibility {
        ...
        object Dialog : Strings.Accessibility.Dialog {
            ...
            override val Disclosure = "$Description\n\nNella schermata di gestione dei servizi di accessibilità ( oppure \"Servizi installati\" per alcuni dispositivi ) cerca 'Shuttle' ed abilitalo. La scorciatoia non è necessaria"
    ...
    object Location : Strings.Location {
        ...
        object Coarse : Strings.Location.Coarse {
            ...
            override val Description = "Shuttle necessita di accedere alla posizione, in modo da mostrare le applicazioni suggerite, in base alla tua posizione corrente\nAbilitando i permessi acconsenti che Shuttle salvi un Geo Hash della tua posizione nel database locale"
        ...
        object Fine : Strings.Location.Fine {
            ...
            override val Description = "Shuttle necessita l'accesso alla posizione precita, in modo da create un Geo Hash da salvere nel database locale"
        ...
        object Background : Strings.Location.Background {
            ...
            override val Description = "Shuttle necessita l'accesso alla posizione in background, in modo da creare un Geo Hash, da salvere nel database locale, ogni volta che un app viene aperta. Inoltre, Shuttle userà la posizione corrente nel Widget, in modo da mostrare suggerimenti in base all posizione corrente"
