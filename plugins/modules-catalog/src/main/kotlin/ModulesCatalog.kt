...
val ModulesCatalog.onboarding get() = OnboardingModuleCatalog(project)
val ModulesCatalog.payments get() = PaymentsModuleCatalog(project)
...
fun OnboardingModuleCatalog.domain() = create("domain")
fun OnboardingModuleCatalog.presentation() = create("presentation")

fun PaymentsModuleCatalog.data() = create("data")
fun PaymentsModuleCatalog.domain() = create("domain")
fun PaymentsModuleCatalog.presentation() = create("presentation")
...
class OnboardingModuleCatalog(project: Project): ModuleCatalog(project, ":shuttle:onboarding:shuttle-onboarding-")
class PaymentsModuleCatalog(project: Project): ModuleCatalog(project, ":shuttle:payments:shuttle-payments-")
